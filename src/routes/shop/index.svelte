...
<div
	class="container  mt-5 grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-5 text-white mx-auto"
>
	{#each $data as item}
		<ShopItem title={item.AssetName} price={item.Price} rare={item.Limited} />
	{/each}
</div>
